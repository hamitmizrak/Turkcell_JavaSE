...
public class _34_Thread3_ImplementsThread2 implements Runnable {
	...
	public _34_Thread3_ImplementsThread2() {
		
	}
	
	// parametreli constructor
	public _34_Thread3_ImplementsThread2(String className) {
		this.className = className;
	}
